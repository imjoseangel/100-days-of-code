...
def retrieve_definition(word):
    ...
    # 2nd elif: To make sure the program return the definition of
    # acronyms (e.g. USA, NATO)
    ...
    # 3rd elif: To find a similar word len > 0 because we can
    # print only when the word has 1 or more close matches
